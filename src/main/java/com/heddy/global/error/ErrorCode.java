...
public enum ErrorCode {
    ...
    FILE_PURPOSE_NOT_ALLOWED(HttpStatus.UNPROCESSABLE_ENTITY, "FILE_PURPOSE_NOT_ALLOWED", "외부에서 요청할 수 없는 파일 용도입니다."),
    FILE_CONTENT_TYPE_MISMATCH(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "FILE_CONTENT_TYPE_MISMATCH", "파일 형식이 업로드 세션과 일치하지 않습니다."),
    FILE_SIZE_MISMATCH(HttpStatus.UNPROCESSABLE_ENTITY, "FILE_SIZE_MISMATCH", "객체 크기가 업로드 세션에 선언한 크기와 일치하지 않습니다."),
